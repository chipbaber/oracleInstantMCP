# Instuctions
The instructions below will highlight how to create a MCP server to a Autonmous Database in the Oracle Cloud. 

# Pre-reqs
- Setup Oracle Instant Client and SQL*Plus Package. This is required to use the python oracledb package
- 
...
- Create a sample table called teamstats
```
...
- Install the python Oracle DB libaries and fastmcp
```
